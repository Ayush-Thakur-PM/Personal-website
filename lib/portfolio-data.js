...
export const portfolio = {
  ...
  nowStudio: {
    ...
    shelf: {
      ...
      books: [
        { status: "re-reading", title: "The Hard Thing About Hard Things", author: "BEN HOROWITZ", quote: "PM crisis playbook." },
        ...
        { status: "re-reading", title: "Never Split the Difference", author: "CHRIS VOSS", quote: "Labels & calibrated questions." },
        { status: "dipping-in", title: "7 Powers", author: "HAMILTON HELMER", quote: "Moat vocabulary." },
        { status: "done", title: "The Lean Startup", author: "ERIC RIES", quote: "Falsifiable KPIs sanity check." },
        { status: "reading", title: "Zero to One", author: "THIEL / MASTERS", quote: "Defensible differentiation." },
        { status: "done", title: "The Mom Test", author: "ROB FITZPATRICK", quote: "Stories, not compliments." },
        { status: "dipping-in", title: "Ego Is the Enemy", author: "RYAN HOLIDAY", quote: "Critique stamina." },
        { status: "re-reading", title: "Salt to the Sea", author: "RUTA SEPETYS", quote: "Many voices in crisis." },
      ],
    ...
    life: {
      rows: [
        { rhythm: "MORNINGS", text: "60 min run + cold shower. Then a pour-over." },
        { rhythm: "WEEKNIGHTS", text: "Founder dinners around Indiranagar. Always one new face." },
        { rhythm: "SUNDAYS", text: "Long-form writing. Building in public on LinkedIn + X." },
        { rhythm: "QUARTERLY", text: "Solo trip — last one: Spiti in the Himalaya." },
        { rhythm: "ALWAYS", text: "Volunteering with a Bangalore-based youth mentoring circle." },
      ],
    },
  },
  ...
  timeline: [
    {
      ...
      stage: "Pre-seed → Seed",
      team: "3",
      funding: "$3M (Lightspeed India, Info Edge)",
      highlights: [
        ...
        "Co-authored the deck and storytelling for the seed round — closed $3M led by Lightspeed India with Info Edge participation.",
      ],
      stack: ["Letta", "Mem0", "LangChain", "N8N", "Airtable"],
    },
    {
      from: "Oct 2024",
      to: "Jul 2025",
      ...
      stack: ["Python", "BigQuery", "Zoho", "GA4", "Mixpanel"],
    },
    {
      from: "Mar 2023",
      to: "Oct 2024",
