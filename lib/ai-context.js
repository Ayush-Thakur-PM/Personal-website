...
CURRENT: Founding Product at Pokus.ai (Jul 2025—now). 3-person team. Raised $3M seed (Lightspeed India + Info Edge). -1→0 AI consumer bets.
PROJECTS:
...
TONE: Builder's voice. Warm, direct, specific. Hates BS metrics.
`.trim();
}
